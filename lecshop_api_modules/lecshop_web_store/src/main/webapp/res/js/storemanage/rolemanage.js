...
var initDataTable = function () {
    $("#dataTable").lsDataTable({
        "ajax": function (data, callback) {
            LSFetch({
                url: basePath + '/store_rolelist.htm?isPaging=1',
...
function loadMenu() {
    LSFetch({
        url: basePath + '/store_roleauthmenu.htm',
...
function addRoleSaveBtn() {
    ...
    LSFetch({
        url: basePath + '/store_addrole.htm',
        data: {
...
function editRole(id, roleName) {
    ...
    LSFetch({
        ...
        success: function (data) {
            LSFetch({
                url: basePath + '/store_queryauthid.htm',
                data: {
                    roleId: id
                },
                success: function (res) {
...
function editRoleSaveBtn() {
    ...
    LSFetch({
        url: basePath + '/store_editrole.htm',
        data: {
            roleId: $("#roleId").val(),
            roleName: roleName,
            authIds: $("#editIds").val()
...
function deleteRoleSaveBtn() {
    ...
    LSFetch({
        url: basePath + '/store_deleterole.htm',
        data: {
