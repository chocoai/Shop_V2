...
var initDataTable = function () {
    $("#dataTable").lsDataTable({
        "ajax": function (data, callback) {
            LSFetch({
                url: basePath + '/store_querybackorders.htm',
...
function toRefundReview(id) {
    window.location.href = basePath + "store_torefundreview.htm?backOrderId=" + id;
}
...
function toReturnReview(id) {
    window.location.href = basePath + "store_toreturnreview.htm?backOrderId=" + id;
}