...
var initDataTable = function () {
    $("#dataTable").lsDataTable({
        "ajax": function (data, callback) {
            LSFetch({
                url: basePath + '/store_queryorders.htm',
...
function confirOrder() {
    LSFetch({
        url: basePath + '/store_confirmorder.htm?id=' + $("#confirmId").val(),
        success: function () {
...
function cancelOrder() {
    LSFetch({
        url: basePath + '/store_cancelorder.htm?id=' + $("#cancelId").val(),
        success: function () {
...
function modifyprice() {
    ...
    LSFetch({
        url: basePath + '/store_modifyprice.htm',
        data: {
...
function toDelivery(id) {
    ...
    LSFetch({
        url: basePath + '/store_querylogisticstemplatebyorderid.htm?id=' + id,
        success: function (res) {
...
function delivery() {
    ...
    LSFetch({
        url: basePath + '/store_deliverorder.htm',
        data: {
            id: $("#deliverId").val(),
...
function todetail(id) {
    window.location.href = basePath + "store_toorderdetail.htm?id=" + id;
}