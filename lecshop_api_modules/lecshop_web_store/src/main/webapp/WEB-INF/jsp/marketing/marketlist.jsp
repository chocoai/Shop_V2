                        ...
                        <div class="btn-group" id="addbtn">
                          <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button"><i class="icon-plus-sign"></i> 添加促销 <span class="caret"></span></button>
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="<%=basePath%>/store_toaddfallmarketing.htm">直降促销</a></li>
                                <li><a href="<%=basePath%>/store_toaddfulldownmarketing.htm">满减促销</a></li>
                                <li><a href="<%=basePath%>/store_toaddfulldiscount.htm">满折促销</a></li>
                            </ul>
                        </div>
                          <a id="addGroup" href="<%=basePath%>/store_toaddgroupmakerting.htm" class="btn btn-primary" style="display: none"><i class="icon-plus-sign"></i> 添加团购</a>
                          <a id="addPanic" href="<%=basePath%>/store_toaddpanicmarketing.htm" class="btn btn-primary" style="display: none"><i class="icon-plus-sign"></i> 添加抢购</a>
