          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <div class="form-horizontal tasi-form set-form">
                <form class="form-horizontal" id="savefulldown" method="post">
                          ...
                          <tr>
                            <td style="line-height:30px">
                              ...
                              <span class="form-group fll"><input id="1" name="fullPrice" type="text"
                                                                  class="manjian form-control required isNumber"
                                                                  value=""
                              ...
                              <span class="form-group fll"><input id="2" type="text" name="reducePrice"
                                                                  class="form-control required isNumber manjian2"
                                                                  value=""
                                                                  style="width:80px; display:inline-block; margin:0 5px"></span>
                              <div class="fll">元</div>
                            </td>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <button type="button" class="btn btn-success btn-lg" onclick="savefulldown()">保存</button>
                  </div>
                </div>
                  </form>
              </div>
...
<script src="<%=basePath %>/res/js/marketing/createfulldown.js"></script>
<script>
</script>
</body>
</html>
