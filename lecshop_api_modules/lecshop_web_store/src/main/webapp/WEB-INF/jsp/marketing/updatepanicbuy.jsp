          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <div class="form-horizontal tasi-form set-form">
                <form class="form-horizontal"  id="updatepanicbuy" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3" style="width:250px">
                      <div class="input-group date search_datetime">
                        <input size="16" type="text" readonly class="form-control required" id="startTime">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <button type="button" class="btn btn-success btn-lg" onclick="updatepanic()">保存</button>
                    </div>
                  </div>
                </form>
              </div>
...
<script src="<%=basePath %>/res/js/marketing/updatepanicbuy.js"></script>
</body>
</html>
