          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <div class="form-horizontal tasi-form set-form">
                <form class="form-horizontal" id="savegroupbuy">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3" style="width:250px">
                      <div class="input-group date search_datetime">
                        <input size="16" type="text" value="" readonly class="form-control" id="startTime" name="startTime">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3" style="width:250px">
                      <div class="input-group date search_datetime">
                        <input size="16" type="text" value="" readonly class="form-control" id="endTime" name="endTime">
                      <span class="input-group-btn">
                      <button type="button" class="btn btn-info date-set"><i class="icon-calendar"></i></button>
                      </span></div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <button type="button" class="btn btn-success btn-lg" onclick="savegroupbuy()">保存</button>
                    </div>
                  </div>
                </form>
              </div>
...
<script src="<%=basePath %>/res/js/marketing/creategroupbuy.js"></script>
