  ...
  <section id="main-content">
    <section class="wrapper site-min-height">
      ...
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            <header class="panel-heading"> 满减促销 </header>
            <div class="panel-body">
              <div class="form-horizontal tasi-form set-form">
                <form class="form-horizontal" id="updatefulldown" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <section class="panel">
                        ...
                        <table class="table" id="fulldowntable">
                        </table>
                      </section>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <button type="button" class="btn btn-success btn-lg" onclick="updatefulldown()">保存</button>
                  </div>
                </div>
                  </form>
              </div>
...
<script src="<%=basePath %>/res/js/marketing/updatefulldown.js"></script>
<script>
</script>
</body>
</html>
