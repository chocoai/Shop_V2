  ...
  <section id="main-content">
    <section class="wrapper site-min-height">
      ...
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            <header class="panel-heading"> 直降促销 </header>
            <div class="panel-body">
              <div class="form-horizontal tasi-form set-form">
                <form class="form-horizontal" id="updatefall" method="post">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label"><span class="label_red">*</span>直降金额：</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control required isNumber" id="price">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-3" style="width:250px">
                      <div class="input-group date search_datetime">
                        <input size="16" type="text"  id="startTime" readonly class="form-control required">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3" style="width:250px">
                      <div class="input-group date search_datetime">
                        <input size="16" type="text" id="endTime" readonly class="form-control required">
                      <span class="input-group-btn">
                      <button type="button" class="btn btn-info date-set"><i class="icon-calendar"></i></button>
                      </span></div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <button type="button" class="btn btn-success btn-lg" onclick="updatefall()">保存</button>
                    </div>
                  </div>
                </form>
              </div>
...
<script src="<%=basePath %>/res/js/marketing/updatefall.js"></script>
