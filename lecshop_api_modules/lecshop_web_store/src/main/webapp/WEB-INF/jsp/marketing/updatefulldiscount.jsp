          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <div class="form-horizontal tasi-form set-form">
                <form class="form-horizontal" id="updatefulldiscount" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <button type="button" class="btn btn-success btn-lg" onclick="updatefulldiscount()">保存</button>
                  </div>
                </div>
                  </form>
              </div>
...
<script src="<%=basePath %>/res/js/marketing/updatefulldiscount.js"></script>
<script>
</script>
</body>
</html>
