                        ...
                        <div class="panel-body">
                            <div class="form-horizontal tasi-form set-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 set_box">
                                        <p class="form-control-static">
                                            <image width="120" height="120" src="<%=basePath %>/store_createqrcode.htm"/>
                                        </p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 set_box">
                                        ...
                                        <form action="store_fileupload.htm" enctype="multipart/form-data" method="post" id="fileForm" target="fileIframe">
                                ...
                                <div class="alert alert-warning fade in">
                                    ...
                                    <strong>注意！</strong> 以下信息用于微信信息设置,可进行编辑修改保存。
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="label_red">*</span>商户号：</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control required" name="mchId" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="label_red">*</span>API密钥：</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control required" name="apiSecret" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="label_red">*</span>AppSecret：</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control required" name="appSecret" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="label_red">*</span>公众号APPID：</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control required" name="appId" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"></label>
                                    <div class="col-sm-5">
                                        <button type="button" class="btn btn-success btn-lg save_btn" onclick="saveBtn()">保存</button>
                                    </div>
                                </div>
                            </div>
                        </div>
