...
<header class="header white-bg">
    ...
    <a href="javascript:window.location.href=window.location.href" class="logo"><img src="http://lecshop.b0.upaiyun.com/1496280394557.jpg" style="max-height: 35px"> </a>
    <ul class="nav_ace">
        <c:forEach items="${storeMenu}" var="firstMenu">
            <c:choose>
    ...
    <div class="top-nav">
        <ul class="nav pull-right top-menu">
            <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">${STORE_LOGIN_SESSION_KEY.userName}</span>
                <b class="caret"></b> </a>
