                        ...
                        <div class="panel-body">
                            <form id="queryform">
                                ...
                                <div class="clearfix m-bot15" style="padding-bottom: 30px; border-bottom: solid 1px #eee;">
                                    <button type="button" class="btn btn-primary" onclick="toAddThematic()"><i class="icon-plus-sign"></i> 添加</button>
...
<script type="text/javascript" src="<%=basePath %>/res/js/infomanage/thematic.js"></script>
<script>
