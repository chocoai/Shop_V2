  ...
  <section id="main-content">
    <section class="wrapper site-min-height">
      ...
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            <header class="panel-heading"> 编辑专题 </header>
              ...
              <form id="editForm">
                <div class="form-horizontal tasi-form set-form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <button type="button" class="btn btn-success btn-lg" onclick="updateThematic()">保存</button>
...
<script type="text/javascript" src="<%=basePath%>/res/js/infomanage/thematicedit.js"></script>
