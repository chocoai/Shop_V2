        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              <div class="mypanel">
                <form class="form-horizontal tasi-form" id="updatespu" enctype="multipart/form-data"  method="post" >
                  <div class="form-group">
                    <label class="col-sm-2 control-label"><span class="label_red">*</span>商品标题：</label>
                    <div class="col-sm-10">
                      <div class="fll" style="width: 80%"><input type="text" class="form-control required specstr" id="spuName" maxlength="100"></div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="fll" style="width: 80%"><input type="text"  class="form-control specstr" id="spuSubTitle" maxlength="100"></div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-2">
                      <div class="input-group ace_group"> <span class="input-group-addon">¥</span>
                        <input type="text"  class="form-control required isNoInteger" id="spuPrice">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <div>
                        <button type="button" class="btn btn-info" onclick="tochoosespecs()">新增规格</button>
                        <div  class="pull-right freight_box sku_sum" style="float:left"> 批量填充：
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input type="text" class="form-control"  id="seoTitle"></input>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">seo关键字：</label>
                    <div class="col-lg-10">
                      <input type="text" class="form-control"  id="seoKeywords" ></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">seo描述：</label>
                    <div class="col-lg-10">
                      <input type="text" class="form-control"  id="seoDesc" ></textarea>
                    </div>
                  </div>
                </form>
                <div style="width:252px; margin:20px auto"> <a class="btn btn-default btn-lg panel_prev" href="javascript:history.go(-1);">返回商品列表</a> <a id="updateSpuId" class="btn btn-info btn-lg" href="javascript:;" onclick="updateSpuSave()">发布商品</a> </div>
              </div>
            </div>
          </section>
        </div>
...
<div class="modal fade" id="addSkuDialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      ...
      <div class="modal-body">
          <div class="form-horizontal tasi-form" id="spuspecspecvalues">
          </div>
      </div>
      <div class="modal-footer">
        <button data-dismiss="modal" class="btn btn-default" type="button">取消</button>
        <button class="btn btn-success" onclick="addupdatesku()" type="button">确定</button>
      </div>
    </div>
  </div>
</div>
...
<script src="<%=basePath %>/res/js/spu/updatespu.js"></script>
</body>
</html>
