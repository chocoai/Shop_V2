              ...
              <form id="addForm">
                <div class="form-horizontal tasi-form set-form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <button type="button" class="btn btn-success btn-lg" onclick="addThematicSetting()">保存</button>
...
<script type="text/javascript" src="<%=basePath%>/res/js/site/thematicadd.js"></script>
