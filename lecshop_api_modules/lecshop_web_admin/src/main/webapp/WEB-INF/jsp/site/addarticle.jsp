    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading"> 添加文章</header>
                            ...
                            <div class="form-horizontal tasi-form set-form">
                                <form id="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control required" value="" name="sort">
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript" src="<%=basePath %>/res/js/site/addarticlelist.js"></script>
</body>
</html>
