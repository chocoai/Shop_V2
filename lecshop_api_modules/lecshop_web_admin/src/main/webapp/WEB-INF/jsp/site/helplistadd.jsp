  ...
  <section id="main-content">
    <section class="wrapper site-min-height">
      ...
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            <header class="panel-heading"> 添加帮助 </header>
              ...
              <div class="form-horizontal tasi-form set-form">
                <form id="addForm">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <button type="button" class="btn btn-success btn-lg" onclick="addHelp()">保存</button>
...
<script type="text/javascript" src="<%=basePath%>/res/js/site/helplistadd.js"></script>
