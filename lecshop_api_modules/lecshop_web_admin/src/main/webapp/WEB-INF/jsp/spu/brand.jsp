  ...
  <section id="main-content">
    <section class="wrapper site-min-height">
      ...
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            <header class="panel-heading"> 商品品牌 </header>
            <div class="panel-body">
              ...
              <div class="clearfix m-bot15" style="padding-bottom: 30px; border-bottom: solid 1px #eee;">
                <button type="button" id="add_btn" class="btn btn-primary" onclick="toaddbrand()"><i class="icon-plus-sign"></i> 添加品牌</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal tasi-form" id="brandoperator" enctype="multipart/form-data"  method="post">
          <div class="form-group">
            <label class="col-sm-3 control-label"><span class="label_red">*</span>品牌名称：</label>
            <div class="col-sm-9">
              <input type="text" class="brandName form-control required specstr" id="brandname" maxlength="25">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">品牌别名：</label>
            <div class="col-sm-9">
              <input id="brandNickName" type="text" class="form-control specstr" maxlength="25">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="fileupload-new thumbnail" style="height: 60px;"><img src="<%=basePath %>/res/img/no_img.png"
                                                                                 alt=""/></div>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-success" type="button" onclick="saveBrand()">保存</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="update_dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal tasi-form" id="updateBrand" enctype="multipart/form-data"   method="post">
          <input type="hidden"  id="updateBrandId"/>
          <div class="form-group">
            <label class="col-sm-3 control-label"><span class="label_red">*</span>品牌名称：</label>
            <div class="col-sm-9">
              <input type="text" id="updateBrandName" class="updateBrandName form-control required specstr" maxlength="25">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">品牌别名：</label>
            <div class="col-sm-9">
              <input id="updateBrandNickName" type="text" class="form-control specstr" maxlength="25">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">LOGO图片：</label>
      ...
      <div class="modal-footer">
        <button data-dismiss="modal" class="btn btn-default" type="button">取消</button>
        <button class="btn btn-success" type="button" onclick="updateBrand()">保存</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="del_dialog">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button data-dismiss="modal" class="btn btn-default" type="button">取消</button>
        <button class="btn btn-success" type="button" onclick="deleteBrand()">确定</button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript" src="<%=basePath%>/res/js/spu/brand.js"></script>
