          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="clearfix m-bot15" style="padding-bottom: 30px; border-bottom: solid 1px #eee;">
                <button type="button" class="btn btn-primary" onclick="toaddspu()"><i class="icon-plus-sign"></i> 添加商品</button>
                <button type="button" class="btn btn-danger" onclick="todeleteSpus()"><i class="icon-trash"></i> 删除</button>
                <button id="createindex" type="button" class="btn btn-success" onclick="createIndex()"><i class="icon-list-ol"></i> 生成索引</button>
                <button type="button" class="btn btn-info" onclick="tobatchup()"><i class="icon-arrow-up"></i> 批量上架</button>
                <button type="button" class="btn btn-info" onclick="tobatchdown()"><i class="icon-arrow-down"></i> 批量下架</button>
                <div class="btn-group">
                  ...
                  <ul role="menu" class="dropdown-menu">
                    <li><a href="#" onclick="exportAll()">导出所有</a></li>
                    <li><a href="#" onclick="exportChecked('goodsIds')">导出选中</a></li>
                  </ul>
                </div>
              </div>
