...
<div class="container">
    <form class="form-signin" id="loginForm">
        <h2 class="form-signin-heading"><img style="max-width:230px" src="" alt=""/></h2>
        <div class="login-wrap">
            ...
            <div class="clearfix">
                ...
                <a href="javascript:;" style="float:left">
                    <img src="createkaptcha.htm" width="90" height="39" alt="点击切换验证码" onclick="this.src=this.src+'?'+Math.random(); "/>
                </a>
            </div>
    ...
    $(function () {
        LSFetch({
            ...
            success: function (data) {
                $("h2 img").attr("src", data.adminLogo);
                if (data.captchaOpen == 1) {
                    isOpen = data.captchaOpen;
                    $(".clearfix").hide();
                }
            }
        });
