...
<head>
    ...
    <link href="<%=basePath %>/res/css/zTreeStyle/zTreeStyle.css" rel="stylesheet">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal tasi-form set-form">
                                <form class="form-horizontal" method="post" id="addtemplate">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"><span
                                                class="label_red">*</span>模板名称：</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"><span
                                                class="label_red">*</span>运费承担：</label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"><span
                                                class="label_red">*</span>计价方式：</label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"><span
                                                class="label_red">*</span>运送方式：</label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group freight_form">
                                        <label class="col-sm-2 control-label"><span
                                                class="label_red">*</span>运费方式：</label>
                                        <div class="col-sm-10">
                                            <div class="panel" style="border:solid 1px #eee">
                                                <header class="panel-heading clearfix" style="background:#eee">
                                                    <div class="pull-left freight_box" style="float:left"> 默认运费：
                                                        <input id="defaultareas" type="hidden" class="input0" value=""/>
                                                        <input type="text" class="form-control input1" value="1">
                                                        <span class="unit"> 件</span>内，
                                                        <input type="text" class="form-control input2" value="0">
                                                        元，每增加
                                                        <input type="text" class="form-control input3" value="1">
                                                        <span class="unit">件</span>，增加运费
                                                        <input type="text" class="form-control input4" value="0">
                                                        元
                                                    </div>
                                                    <div class="pull-right">
                                                        <button id="add_btn" type="button"
                                                                class="btn btn-primary btn-sm" onclick="toadd()">添加收货地区
                                                        </button>
                                                    </div>
                                                </header>
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <th width="50%">收货地区</th>
                                                        <th class="unit_th">首件</th>
                                                        <th>首费(元)</th>
                                                        <th class="unit_th">续件</th>
                                                        <th>续费(元)</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody id="tempdetail">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <button type="button" class="btn btn-success btn-lg"
                                                    onclick="savetemplte()">保存
                                            </button>
                                            <button type="button" onclick="back()" class="btn btn-default btn-lg">取消</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal tasi-form" id="addshipping">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span id="num">首件个数</span>：</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control required digits" value="1" id="firstnum">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span id="fee">首件运费</span>：</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control required number" value="0" id="firstfee">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span id="xujian">续件个数</span>：</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control required digits" value="1" id="contnum">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span id="xufee">续件运费</span>：</label>
                        <div class="col-sm-2">
...
<script type="text/javascript" src="<%=basePath%>/res/js/order/addlogistictemplate.js"></script>
</body>
</html>
