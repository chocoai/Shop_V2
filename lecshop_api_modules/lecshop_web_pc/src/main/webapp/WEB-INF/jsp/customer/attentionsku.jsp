        ...
        <div class="main">
            <div class="myfollow-hd">
                <ul class="tab-trigger">
                    <li class="curr"><a href="toattentionsku.htm">关注的商品</a></li>
                    <li><a href="toattentionstore.htm">关注的店铺</a></li>
                </ul>
            </div>
            <div class="myfollow-bd">
                <div class="myfollow-main">
                    <div class="mf-goods-list clearfix"></div>
                    <div class="mt20 clearfix">
                        <div class="flr" id="attentionPage"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="<%=basePath %>/res/js/customer/attentionsku.js"></script>
</body>
</html>
